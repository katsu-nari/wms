-- =====================================================================
-- LogiCore WMS - 0011_p4_3_atomic.sql
-- P4.3 安定化: アトミック登録RPC / 商品照合RPC
-- =====================================================================

-- ---------------------------------------------------------------------
-- ① fn_create_inbound_plan : 入荷予定を1トランザクションで作成
--    採番 → inbound_plans INSERT → inbound_plan_items INSERT
--    失敗時は全ロールバック（欠番なし）
-- ---------------------------------------------------------------------
...
-- ---------------------------------------------------------------------
-- ② fn_validate_inbound_items : 商品照合RPC
--    入力: JAN/SKUの配列 → 商品IDとエラー情報を返却
-- ---------------------------------------------------------------------
